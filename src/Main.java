...
public class Main {
    ...
    private static void getCardinalities(String filename) {
        ...
        try {
            ...
            for (int i = 0; i < values.length; i++) {
                ...
                mainCube.initDim(i - 1, highestValue[i], lowerValue);
            ...
            for (int i = 0; i < numberTuples; ++i) {
                ...
                for (int n = 0; n < numDimns; n++)
                    ++storeAttValueUsage[n][Integer.parseInt(values[n])];
            }
    ...
    private static void addInfoToDataCube(String filename) {
        ...
        try {
            ...
            for (int i = 0; i < mainCube.getNumberTuples(); ++i) {
                ...
                for (int n = 0; n < values.length; n++) {
                    tupleValues[i] = Integer.parseInt(values[i + 1]);
                }
